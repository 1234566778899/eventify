...
export const Profile = () => {
    ...
    const [tabMessage, setTabMessage] = useState(false);
    const closeMessage = () => setTabMessage(false);
    ...
    return userInfo && (
        <>
            {
                tabMessage && (<Message close={closeMessage} />)
            }
            <div className='inter'>
                <Navbar />
                <div className='container'>
                    ...
                    <div className='content-profile'>
                        ...
                        <div >
                            ...
                            {
                                optionActive == '3' && (
                                    <Spaces onConfirm={registerSpace} />
                                )
                            }
                        </div>
                    </div>
